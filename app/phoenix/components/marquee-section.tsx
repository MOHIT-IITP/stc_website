  ...
  return (
    <section className="relative w-full py-8 overflow-hidden">
      ...
      <div className="relative z-10 w-full overflow-hidden">
        ...
        <h2 className="whitespace-nowrap text-[clamp(2rem,5vw,4rem)] font-extrabold uppercase tracking-[0.2em] 
        bg-gradient-to-r from-[#48645D] via-white to-[#48645D] bg-clip-text text-transparent opacity-80 text-center">
