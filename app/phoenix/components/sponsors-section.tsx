  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-12 lg:px-20">
        ...
        <div className="mx-auto grid max-w-6xl grid-cols-1 gap-6 md:grid-cols-2 md:gap-6 lg:grid-cols-3 xl:gap-8">
          <a
            href="#contact"
            className="group relative md:col-span-2 lg:col-span-1 cursor-pointer"
          >
            <div className="relative h-[300px] overflow-hidden rounded-xl border border-green-300/40 bg-gradient-to-br from-green-400/10 via-emerald-500/10 to-lime-400/5 backdrop-blur-md transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-green-400/20 md:h-[300px] xl:h-[350px]">
              ...
              <div className="relative flex h-full flex-col items-center justify-center p-6 md:p-6 xl:p-8">
                ...
                <p className="text-white/60 text-xs md:text-sm text-center mb-4 max-w-[240px]">
                  Be part of the Phoenix event. Add yourself as a sponsor and
