...
export const metadata: Metadata = {
  ...
  description:
    "STC IITP - Official Student Technical Council IIT Patna Hybrid Programs. STC Hybrid offers technical excellence through DISHA, ARTHNITI, and TATVA wings. Join Student Technical Council Hybrid for innovation and leadership.",
  keywords: [
    "STC",
    "STC IITP",
    "STC IIT Patna",
  ...
  openGraph: {
    ...
    url: "https://stciitphybrid.in",
    siteName:
      "STC IITP - Student Technical Council for Hybrid Programs IIT Patna",
    title: "STC IITP | Student Technical Council for Hybrid Programs IIT Patna",
    description:
      "STC IITP - Official Student Technical Council for Hybrid Programs IIT Patna. Technical excellence through DISHA, ARTHNITI, and TATVA wings.",
    images: [
      {
...
export default function RootLayout({
  ...
  const jsonLd = {
    ...
    legalName:
      "Student Technical Council for Hybrid Programs, Indian Institute of Technology Patna",
    alternateName: [
      "STC IITP",
      "STC IIT Patna",
      "STC Hybrid",
    ...
    description:
      "Official Student Technical Council IIT Patna Hybrid Programs offering technical excellence through DISHA, ARTHNITI, and TATVA wings. Leading student organization for technical events, workshops, and innovation.",
    url: "https://stciitphybrid.in",
    logo: {
      "@type": "ImageObject",
    ...
    department: [
      {
        ...
        name: "DISHA",
        description:
          "Career Growth & Training Cell - Empowering students with skills and professional development",
      ...
      },
      {
        ...
        name: "ARTHNITI",
        description:
          "Entrepreneurship & Innovation Cell - Supporting startup culture and innovation",
      ...
      },
      {
        ...
        name: "TATVA",
        description:
          "Technology & Research Cell - Promoting technical expertise and research",
    ...
    mainEntity: [
      {
        ...
        url: "https://stciitphybrid.in",
        description:
          "Welcome to the official website of STC IIT Patna Hybrid Programs",
      },
      {
        "@type": "WebPage",
        name: "Our Wings",
        ...
        description:
          "Explore the various wings of STC IIT Patna Hybrid Programs",
      },
      {
        "@type": "WebPage",
        name: "Event Calendar",
        ...
        description:
          "View upcoming technical events and workshops by STC IITP Hybrid Programs",
      },
      {
        "@type": "WebPage",
        name: "About STC IITP",
        ...
        description:
          "Learn about Student Technical Council for hybrid programs IIT Patna",
      },
      {
        "@type": "WebPage",
        name: "Our Team",
