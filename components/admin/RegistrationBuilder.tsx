...
export default function RegistrationBuilder() {
  ...
  const deleteTemplate = async (id: string) => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/admin/registration-templates?id=${id}`,
        {
          method: "DELETE",
        },
      );
  ...
  const saveField = () => {
    ...
    const existingFieldIndex = currentTemplate.fields.findIndex(
      (f) => f.key === editingField.key,
    );
    ...
    <div className="space-y-6">
                ...
                <CardContent>
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button
                      ...
                      variant="destructive"
                      onClick={() =>
                        template._id && deleteTemplate(template._id)
                      }
                    >
          ...
          <CardContent className="space-y-6">
            ...
            <div>
              ...
              <div className="mt-2 space-y-4">
                ...
                <p className="text-xs text-gray-500">
                  Upload an image for this form (max 5MB). This will be shown on
                  the form details page.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between space-x-4">
              ...
              <div className="flex items-center space-x-2">
                <Switch
                  id="show"
                  checked={currentTemplate.show}
                  onCheckedChange={(checked) =>
                    setCurrentTemplate({ ...currentTemplate, show: checked })
                  }
                />
                <Label htmlFor="show">Show in Public Registration</Label>
              </div>
            </div>
                    ...
                    {currentTemplate.fields
                      ...
                      .map((field) => (
                        ...
                        >
                          ...
                          {field.type === "image" && (
                            <p className="text-xs text-gray-500 mt-1">
                              Max file size: {field.maxFileSize || 5} MB
                            </p>
                          )}
                        </div>
                      ))}
      ...
      <Dialog open={showFieldEditor} onOpenChange={setShowFieldEditor}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>
              {editingField?.key ? "Edit Field" : "Add Field"}
            </DialogTitle>
          </DialogHeader>
          {editingField && (
            <div className="space-y-4">
              ...
              <div>
                ...
                />
                <p className="text-xs text-gray-500 mt-1">
                  This will be displayed as the question/label for users
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="flex items-center space-x-2">
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      setEditingField({ ...editingField, important: checked })
                    }
                  />
              ...
              {editingField.type === "email" && (
                <div>
                  <Label htmlFor="emailRestriction">
                    Email Domain Restriction
                  </Label>
                  <Select
                    value={editingField.emailRestriction || "all"}
                    onValueChange={(value: "all" | "iitp") =>
                      setEditingField({
                        ...editingField,
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => {
                      if (checked) {
                        ...
                        const { conditional: _conditional, ...rest } =
                          editingField;
                        setEditingField(rest);
                      }
                    }}
                  />
                  <Label htmlFor="enableConditional">
                ...
                {editingField.conditional && currentTemplate && (
                  <div className="space-y-3 p-3 bg-gray-50 rounded-md">
                    ...
                    <p className="text-xs text-gray-500 mt-2">
                      <strong>Example:</strong> Show "Company Name" when
              ...
              <div className="border-t pt-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {["text", "textarea", "email", "tel", "url"].includes(
                    editingField.type,
                  ) && (
                    <>
                      <div>
