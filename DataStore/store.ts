...
const domains = {
  ...
  tatva: {
    ...
    team: [
      ...
      },
      {
        ...
        linkedin: "https://www.linkedin.com/in/debojyoti-de-majumder-48052b30b/",
    ...
    team: [
      {
        ...
        linkedin: "https://www.linkedin.com/in/deepak-pareek-ml-datascience-mtech-iitpatna",
  ...
  disha: {
    careerCatalyst: {
      ...
      cardUrl: AppConfig.imageUrls.ArenaBox2,
      description: "Welcome to Career Catalyst, the Career Development Club! 🚀 Whether you're exploring career options or preparing for placements, join us to build your professional skills and network with industry experts.",
    ...
    opportune: {
      ...
      whatsappLink: "https://chat.whatsapp.com/example",
      cardUrl: AppConfig.imageUrls.CodeRedBox2,
      description: "Welcome to Opportune, the Opportunity Club! 💼 Whether you're seeking internships, projects, or career opportunities, join us to connect with the right opportunities at the right time.",
  ...
  arthniti: {
    foundersForge: {
      ...
      whatsappLink: "https://chat.whatsapp.com/example",
      cardUrl: AppConfig.imageUrls.SynapseBox2,
      description: "Welcome to Founders Forge, the Entrepreneurship Club! 🚀 Whether you have a startup idea or want to join a founding team, this is your platform to turn ideas into reality.",
    ...
    freelanthropy: {
      ...
      whatsappLink: "https://chat.whatsapp.com/example",
      cardUrl: AppConfig.imageUrls.PixelBox2,
      description: "Welcome to Freelanthropy, the Freelancing Club! 💼 Whether you want to start freelancing or grow your freelance business, join us to learn the art of independent work.",
  ...
  management: {
    creative: {
      ...
      whatsappLink: "https://chat.whatsapp.com/example",
      cardUrl: AppConfig.imageUrls.AppBox2,
      description: "Welcome to Creative, the Creative Club! 🎨 Whether you're into design, content creation, or creative arts, join us to express your creativity and collaborate on amazing projects.",
    ...
    eventManagement: {
      ...
      whatsappLink: "https://chat.whatsapp.com/example",
      cardUrl: AppConfig.imageUrls.HackBox2,
      description: "Welcome to Event Management, the Event Management Club! 🎪 Whether you love organizing events or managing logistics, join us to create memorable experiences and develop your event management skills.",
    ...
    pr: {
      ...
      whatsappLink: "https://chat.whatsapp.com/example",
      cardUrl: AppConfig.imageUrls.NewsBox2,
      description: "Welcome to PR, the Public Relations Club! 📢 Whether you're into communications, branding, or public speaking, join us to build your PR skills and represent the organization.",
    ...
    sessionWebinar: {
      ...
      whatsappLink: "https://chat.whatsapp.com/example",
      cardUrl: AppConfig.imageUrls.MechXBox2,
      description: "Welcome to Session & Webinar, the Session & Webinar Club! 🎥 Whether you love organizing sessions, webinars, or workshops, join us to bring knowledge and expertise to the community.",
    ...
    sponsor: {
      ...
      description: "Welcome to Sponsor, the Sponsorship Club! 💰 Whether you're into fundraising, sponsor relations, or partnership building, join us to secure resources for our initiatives.",
